...
const PageContestManageModerators: Component = () => {
	...
	const SectionModeratorsEmpty = () => {
		return (
			<div id="container-contest-moderators-empty">
				...
				<span>{t("pages.contest.manage.moderators.empty.text")}</span>
			</div>
		);
	};
	...
	const SectionFooter = () => {
		return (
			<Show when={data.moderators}>
				<footer>
					<CustomMainButton
						text={t("pages.contest.manage.moderators.buttons.revoke")}
					...
					<CustomMainButton
						text={t("pages.contest.manage.moderators.buttons.invite")}
				...
				<div>
					<header>
						<div>
							...
							<p>{t("pages.contest.manage.moderators.description")}</p>
						</div>
					</header>
