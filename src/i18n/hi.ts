const dict_hi = {
	...
	pages: {
		...
		create: {
			options: {
				...
				description: {
					placeholder: "प्रतियोगिता के बारे में और बताओ",
				},
				instruction: {
					placeholder: "क्या जमा करना है — लिंक और प्रारूप",
				},
				duration: {
					label: "अवधि",
					options: {
			...
			wallet: {
				...
				hint: "प्रत्येक प्रवेश पर {commission}% सेवा शुल्क लागू होता है।",
				button: { text: "वॉलेट कनेक्ट करें" },
			},
			done: {
				title: "तैयारी हो रही है...",
				description:
					"हम आपकी प्रतियोगिता तैयार कर रहे हैं और जैसे ही आपका भुगतान संसाधित होगा, आपको सूचित किया जाएगा।",
			},
			button: { create: { text: "बनाएँ", for: "{amount} TON में बनाएँ" } },
		...
		contest: {
			...
			manage: {
				...
				moderators: {
					title: "मॉडरेटर",
					description: "प्रस्तुतियाँ देख और उन पर वोट कर सकते हैं।",
					empty: {
						text: "अभी यहाँ कोई नहीं है।",
					},
					buttons: {
				...
				submissions: {
					...
					export: {
						button: "निर्यात करें",
						confirm: {
							title: "प्रविष्टियाँ निर्यात करें",
							text: "क्या आप सभी प्रविष्टियों को CSV फ़ाइल के रूप में निर्यात करना चाहते हैं?",
							export: "निर्यात करें",
						},
					},
				},
	...
	modals: {
		...
		participate: {
			title: "प्रतियोगिता में शामिल हों",
			instruction: {
				title: "क्या जमा करें",
				default: "कृपया अपने काम का लिंक और संक्षिप्त विवरण दें",
			},
			form: {
				title: "प्रस्तुति",
				description: {
					placeholder: "आपके काम के लिंक और विवरण",
				},
				button: "जमा करें",
			},
			profile: "<b>{profile}</b> प्रस्तुति पर दिखेगा",
			confirm: {
				title: "जमा करें",
				prompt: "क्या आप इस प्रतियोगिता के लिए अपनी प्रविष्टि जमा करना चाहते हैं?",
				button: "जमा करें",
			},
			done: {
				title: "हमने आपकी प्रविष्टि प्राप्त कर ली है",
				description: "अब अपनी उंगलियां क्रॉस करें और परिणामों की प्रतीक्षा करें",
			},
		},
		submission: {
