	...
	pages: {
		...
		create: {
			...
			wallet: {
				...
				hint: "يتم تطبيق رسوم خدمة {commission}٪ على كل مشاركة.",
				button: { text: "ربط المحفظة" },
			},
			done: {
				title: "جاري التحضير...",
				description: "نحن نحضر مسابقتك وسيتم إعلامك بمجرد معالجة دفعتك.",
			},
		...
		contest: {
			...
			manage: {
				...
				moderators: {
					title: "المشرفون",
					description: "يمكنك عرض التصويتات والمشاركات.",
					empty: {
						text: "لا يوجد أحد هنا بعد.",
					},
					buttons: {
						invite: "دعوة",
						revoke: "إلغاء الرابط",
