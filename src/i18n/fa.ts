const dict_fa = {
	...
	pages: {
		...
		create: {
			options: {
				...
				description: {
					placeholder: "بیشتر درباره مسابقه بگو",
				},
				instruction: {
					placeholder: "چه چیزی ارسال شود — لینک‌ها و قالب",
				},
				duration: {
					label: "مدت زمان",
					options: {
			...
			wallet: {
				...
				hint: "{commission}٪ کارمزد خدمات برای هر ورود اعمال می‌شود.",
				button: { text: "اتصال کیف پول" },
			},
			done: {
				title: "در حال آماده‌سازی...",
				description:
					"ما در حال آماده‌سازی مسابقه شما هستیم و به‌محض پردازش پرداخت، به شما اطلاع داده خواهد شد.",
			},
		...
		contest: {
			...
			manage: {
				...
				moderators: {
					title: "مدیران",
					description: "می‌تواند ارسال‌ها را مشاهده و رأی دهد.",
					empty: {
				...
				submissions: {
					...
					export: {
						button: "خروجی گرفتن",
						confirm: {
							title: "خروجی گرفتن از ارسال‌ها",
							text: "آیا می‌خواهید همه ارسال‌ها را به صورت فایل CSV خروجی بگیرید؟",
							export: "خروجی گرفتن",
						},
					},
				},
	...
	modals: {
		...
		participate: {
			...
			instruction: {
				title: "چه چیزی ارسال کنید",
				default: "لطفاً یک لینک و توضیح کوتاه از کار خود ارائه دهید",
			},
			form: {
				title: "ارسال",
				description: {
					placeholder: "لینک‌ها و توضیح کار شما",
				},
				button: "ارسال",
			},
			profile: "<b>{profile}</b> در ارسال نمایش داده می‌شود",
			confirm: {
				title: "ارسال",
				prompt: "آیا می‌خواهید اثر خود را برای این مسابقه ارسال کنید؟",
				button: "ارسال",
			},
			done: {
				title: "ما اثر شما را دریافت کردیم",
				description: "حالا انگشتان خود را روی هم بگذارید و منتظر نتایج باشید",
			},
		},
		submission: {
