	...
	pages: {
		...
		create: {
			...
			wallet: {
				...
				title: "Подготовка...",
				description:
					"Мы готовим ваш конкурс и уведомим вас, как только ваш платеж будет обработан.",
			},
			button: { create: { text: "Создать", for: "Создать за {amount} TON" } },
		...
		contest: {
			...
			manage: {
				...
				moderators: {
					title: "Модераторы",
					description: "Может просматривать и голосовать за работы.",
					empty: {
				...
				submissions: {
					...
					export: {
						...
						confirm: {
							...
							text: "Вы хотите экспортировать все заявки в файл CSV?",
							export: "Экспорт",
						},
					},
				},
